...
export interface IChargeService {
  _find: FindMethod<ParamsWithStripeQuery<Stripe.ChargeListParams>, Stripe.Charge>;
  ...
  _patch: (id: string, data: ({ capture: boolean } & Stripe.ChargeCaptureParams) | Stripe.ChargeUpdateParams, params: ParamsWithStripe) => Promise<Stripe.Charge>;
